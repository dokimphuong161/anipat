...
const Services = (props) => {
    ...
    return (
        <section className="services py-10 md:px-0 px-4">
            <div className="container mx-auto">
                <div className="section-heading md:w-1/2 w-auto text-center mx-auto">
                    ...
                    <h1 className="md:text-[50px] md:leading-[60px] text-[32px] leading-[42px] font-bold">
                        We look after you pets with our best staffs
                    </h1>
                    <p className="mt-4">
                ...
                <div className="services-list grid md:grid-cols-3 md:grid-rows-2 grid-cols-1 mt-[115px] gap-4">
                    {renderServiceList}
                </div>
            </div>
        </section>
